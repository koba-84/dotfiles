...
source_all_in_directory() {
    ...
    # Iterate over all files with .sh extension in the directory
...
source_all_in_directory "$HOME/.dotfiles/sources/general"

# Source work configs from private dotfiles
